...
void 0!==window.ShadyCSS&&window.ShadyCSS.prepareTemplate(a,b.is);return a}static register(){window.customElements.define(b.is,b)}constructor(a=b.template){super(a);this._bar=this.shadowRoot.querySelector("#bar");this._knob=this._bar.querySelector("#knob")}connectedCallback(){this.styleUpdated();this.hasAttribute("role")||this.setAttribute("role","checkbox");super.connectedCallback()}styleUpdated(){let a=getComputedStyle(this._bar);this.style.setProperty("--catalyst-toggle-switch-bar-border-top-wdith",
a.borderTopWidth);this.style.setProperty("--catalyst-toggle-switch-bar-border-left-wdith",a.borderLeftWidth);0>Number.parseFloat(getComputedStyle(this).getPropertyValue("--catalyst-toggle-switch-knob-offset"))&&this._bar.classList.add("negitive-knob-offset")}}window.CatalystElements.CatalystToggleSwitch=b;b.register()}window.CatalystElements=window.CatalystElements||{};void 0===window.CatalystElements.CatalystToggleSwitch?void 0===window.WebComponents||window.WebComponents.ready?c():window.addEventListener("WebComponentsReady",
()=>{c()}):console.warn("CatalystToggleSwitch has already been defined, cannot redefine.")})();})()
